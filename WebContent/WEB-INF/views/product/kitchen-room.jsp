	...
	<section class="product">
		<div class="container">
			<div class="product-content">
				...
				<img
					src="https://bizweb.dktcdn.net/100/368/970/collections/home-01-1676x731.jpg?v=1575619402893"
					alt="Kitchen-room" />
				...
				<div class="product-filter flex">
					...
					<div class="list-item-filter-chose">
						<div name-list="species" class="item-filter-chose flex j-between"
							href="#">
							<p class="title-filter">Species</p>
							<span><i class="fas fa-caret-down"></i></span>
						</div>
					</div>
				</div>
				<div class="all-products">
					...
					<div class="all-products-content">
						<div class="row">
							<c:forEach var="s" items="${product_kitchenrooms}">
