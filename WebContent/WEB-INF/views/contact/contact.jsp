					...
					<div class="items col-md-4 j-end">
						<div class="logo-right flex a-center j-end">
							...
							<ul class="multi-language">
								<li><a href="" data-lang="en"><img src="${pageContext.request.contextPath}/dist/img/English-Language-Flag.png"
											alt="photo"></a>
								<li>
								<li><a href="" data-lang="vi"><img src="${pageContext.request.contextPath}/dist/img/Vietnam-Flag-icon.png"
											alt="photo"></a>
								<li>
							</ul>
							<div>
							...
							<a href="#"> <i class="fas fa-shopping-cart"></i>
								<div class="giohang">
									<p><s:message code="global.home.CartNotification"/></p>
								</div>
							</a>
						</div>
					</div>
...
<!-- Thông tin tài khoản -->
    ...
    <section class="contact">
      <div class="container">
        <div class="contact-content flex j-between">
          <div class="contact-left">
            <h3>CONTACT</h3>
            <p>
              MewMew Investment Joint Stock Company is the No. 1 retailer in Vietnam in terms of
              revenue and profit, with a network of more than 2,200 stores nationwide. MewMew
              operates chain stores - restaurants MewFurniture, MewNature, MewINT, MewCoffee. In
              addition, MewMew has expanded to overseas markets of Mew Furniture furniture chain in
              Southeast Asian countries
            </p>
            <p>Headquarters: 17/110 Tran Duy Hung</p>
            <p>
              Hotline: <span><a href="#">0975997736</a></span>
            </p>
            <p>
              Email: <span><a href="#">jansperry4@gmail.com</a></span>
            </p>
          </div>
          <div class="contact-right">
            ...
            <div class="item-input-right">
              ...
              <textarea class="item-input-right-content"></textarea>
        ...
        <div class="contact-map">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.542638294715!2d106.78806281341957!3d10.84627029227418!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527145b767213%3A0x837d366798a084cd!2zMTA1LCA2IMSQxrDhu51uZyAzODUsIFTEg25nIE5oxqFuIFBow7ogQSwgUXXhuq1uIDksIEjhu5MgQ2jDrSBNaW5oLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1589093030482!5m2!1svi!2s"
            width="600"
            height="450"
            frameborder="0"
            style="border: 0;"
